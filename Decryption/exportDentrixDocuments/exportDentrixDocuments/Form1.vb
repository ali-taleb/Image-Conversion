...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Not Directory.Exists(Label2.Text) Then
            ...
            Exit Sub
        End If
        files = My.Computer.FileSystem.GetFiles(Label2.Text, FileIO.SearchOption.SearchAllSubDirectories).Where(Function(saa) Path.GetExtension(saa).ToLower = ".zed" Or Path.GetExtension(saa).ToLower = ".zeni").ToArray
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        For i = 0 To files.Count - 1
            ...
            If extract Then
                Dim id = ""
                Try
                    id = getIDFromarr(getID(files(i)), arr)
                ...
                If id = "" Then
                    Label6.Invoke(Sub()
                                  ...
                                  End Sub)
                    log("error 58958 doc id was not found in file " & getID(files(i)))
                Else
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim s = "This is the new version of instructions: download the folder of database DentrixSQL and put it in the folder C:\FairCom\V11.0.0\winX64\bin\ace\sql\data " & vbNewLine &
